import 'package:com_policing_incident_app/widgets/date_lable.dart';
import 'package:com_policing_incident_app/widgets/glowing_action_button.dart';
import 'package:com_policing_incident_app/widgets/message_own_tile.dart';
import 'package:com_policing_incident_app/widgets/message_tile.dart';
        ...
        Expanded(
          child: Padding(
            ...
            child: ListView(children: const [
              ...
              MessageOwnTile(
                  message:
                      'Hi Hannah, i want to report a human abuse case,Can you help me out',
                  messageDate: '9:38 PM'),
              MessageTile(
              ...
              MessageOwnTile(
                  message:
                      'I am so traumatized and currently in a very bad condition',
                  messageDate: '9:40 PM'),
              MessageTile(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            setState(() {
                              ...
                              show =
                                  !show; // show is the negative of show(true)
                            });
                          },
                        ),
                      ),
